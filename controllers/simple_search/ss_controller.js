/*
Program: simple search controller
Description: contains functions related to simple search task
Called-by: simple_search.js
...
const home_page = (req, res) => {
  try{
    ...
    console.log('touched : controllers/simple_search/ss_controller -> home_page')
    console.log(error);
