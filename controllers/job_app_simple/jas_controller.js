...
const list = async (req, res) => {
  try{
    ...
    console.log('touched : controller/job_app_simple/jas_controller -> list')
    console.log(error);
...
const form_page = async (req, res) => {
  ...
  try{
    ...
    console.log('touched : controller/job_app_simple/jas_controller -> form_page')
    console.log(error);
    res.render('error_page');
  }
...
const submit = async (req, res) => {
  ...
  try{
    ...
    console.log('touched : controller/job_app_simple/jas_controller -> submit')
    console.log(error);
    res.render('error_page');
  }
...
const update_user = async (req, res) => {
  ...
  try{
    ...
    console.log('touched : controller/job_app_simple/jas_controller -> update_user')
    console.log(error);
    res.render('error_page');
  }
