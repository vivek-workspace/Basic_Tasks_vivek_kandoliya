...
function generateQuery(fields, values) {
  try{
    ...
    console.log('touched : controllers/common/common -> generateQuery')
    console.log(error);
...
function generateUpdateQuery(fields, values) {
  try{
    ...
    console.log('touched : controllers/common/common -> generateUpdateQuery')
    console.log(error);
    return res.render('error_page');
  }
...
function generateConditionalSelect(fields, values) {
  try{
    ...
    console.log('touched : controllers/common/common -> generateConditionalSelect')
    console.log(error);
    return res.render('error_page');
  }
...
async function insertBasicDetails(formData) {
  try{
    ...
    console.log('touched : controllers/common/common -> insertBasicDetails')
    console.log(error);
    return res.render('error_page');
  }
...
async function insertEducationalDetails(formData, id) {
  try{
    ...
    console.log('touched : controllers/common/common -> insertEducationalDetails')
    console.log(error);
    return res.render('error_page');
  }
...
async function insertWorkexperienceDetails(formData, id) {
  ...
  try{
    ...
    console.log('touched : controllers/common/common -> insertWorkexperienceDetails')
    console.log(error);
    return res.render('error_page');
  }
...
async function insertLanguages(formData, id){
  try{
    ...
    console.log('touched : controllers/common/common -> insertLanguages')
    console.log(error);
    return res.render('error_page');
  }
...
async function insertTechnologies(formData, id){
  ...
  try{
    ...
    console.log('touched : controllers/common/common -> insertTechnologies')
    console.log(error);
    return res.render('error_page');
  }
...
async function insertReferanceContact(formData, id){
  try{
    ...
    console.log('touched : controllers/common/common -> insertReferanceContact')
    console.log(error);
    return res.render('error_page');
  }
...
async function updateBasicDetails(formData){
  ...
  try{
    ...
    console.log('touched : controllers/common/common -> updateBasicDetails')
    console.log(error);
    return res.render('error_page');
  }
...
async function updateEducationalDetails(formData){
  try{
    ...
    console.log('touched : controllers/common/common -> updateEducationalDetails')
    console.log(error);
    return res.render('error_page');
  }
...
async function updateLanguageDetails(formData){
  ...
  try{
    ...
    console.log('touched : controllers/common/common -> updateLanguageDetails')
    console.log(error);
    return res.render('error_page');
  }
}
...
async function updateTechnologyDetails(formData){
  ...
  try{
    ...
    console.log('touched : controllers/common/common -> updateTechnologyDetails')
    console.log(error);
    return res.render('error_page');
  }
...
async function updateWorkExperience(formData){
  ...
  // console.log(ans);
    ...
    console.log('touched : controllers/common/common -> updateWorkExperience')
    console.log(error);
    return res.render('error_page');
  }
...
async function updateReferenceContacts(formData){
  try{
    ...
    console.log('touched : controllers/common/common -> updateReferenceContacts')
    console.log(error);
    return res.render('error_page');
  }
...
function filterRows(data) {
  try{
    ...
    console.log('touched : controllers/common/common -> filterRows')
    console.log(error);
    return res.render('error_page');
  }
...
function removeEmpty(array){
  try{
    ...
    console.log('touched : controllers/common/common -> removeEmpty')
    console.log(error);
    return res.render('error_page');
  }
}
